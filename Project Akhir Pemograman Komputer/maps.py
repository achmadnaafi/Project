...
class Maps:
    ...
    def level_cleared(self):
        ...
        level_cleared_text = interface.Label(480, 100, 400, 200, None, self.color['background'])
        ...
        if self.level <= self.max_level:
            next = interface.Button(500, 500, 300, 100, self.draw_map, (88, 214, 141), (171, 235, 198))
